...
import { Actor, actorCalled, ArtifactArchiver, Cast, configure, engage, TestCompromisedError } from '@serenity-js/core';
...
describe('05 Local Server (solution)', () => {
    ...
    describe('Todo List app API', () => {
        ...
        describe('test outcome', () => {
            ...
            it('can be marked as compromised', () =>
                actorCalled('Alice').attemptsTo(
                    Ensure.that(false, equals(true)).otherwiseFailWith(TestCompromisedError, 'Infrastructure failure')
                )
            )
        });
